...
**Cita del repositorio suplementario (formato APA):**

> Victoria Niño, M. J. (2026). *DesignStormDuration-CVC v1.0.0* [Software]. GitHub. https://github.com/MauricioVictoriaN/DesignStormDuration-CVC

**Entrada BibTeX:**

```bibtex
% Citar el preprint publicado:
@article{victoriaNino2026design,
  author    = {Victoria Niño, Mauricio Javier},
  title     = {Design storm duration from hourly rainfall records
               in a bimodal Andean climate},
  journal   = {engrXiv},
  year      = {2026},
  doi       = {10.31224/7062},
  url       = {https://doi.org/10.31224/7062}
}

% Citar el repositorio suplementario:
@misc{victoriaNino2026software,
  author    = {Victoria Niño, Mauricio Javier},
  title     = {{DesignStormDuration-CVC} v1.0.0: Supplementary
               implementation for design storm duration analysis},
  year      = {2026},
  publisher = {GitHub},
...
- Moriasi, D.N. et al. (2007). Model evaluation guidelines for systematic quantification of accuracy in watershed simulations. *Transactions of the ASABE*, 50(3), 885–900. https://swat.tamu.edu/media/1312/moriasimodeleval.pdf
...
- Poveda, G. et al. (2002). Seasonality in ENSO-related precipitation, river discharges, soil moisture, and vegetation index in Colombia. *Water Resources Research*, 37(8). https://doi.org/10.1029/2000WR900395
